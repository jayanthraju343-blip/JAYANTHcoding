...
GRAY="\e[90m"
NC="\e[0m"
URL="https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/Extras"
# ===================== PAUSE =====================
pause() {
  ...
  while true; do
    ...
    case "$im" in
      ...
      5)
        ...
        bash <(curl -fsSL https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/Extras/docker.sh)
        pause
        ;;
