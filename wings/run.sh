...
while true; do
    ...
    case $opt in
        1) ssl_setup ;;
        2) bash <(curl -fsSL https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/wings/install.sh) ;;
        3) bash <(curl -fsSL https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/wings/mang.sh) ;;
