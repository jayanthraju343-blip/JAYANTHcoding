    ...
    while true; do
        ...
        case $p in
            1)  echo -e "  ${CYAN}➜ Executing Pterodactyl Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/pterodactyl/run.sh) 
                pause ;;
            ...
            4)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/reviactyl/run.sh)
                pause ;;
            5)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s ) 
                pause ;;
            6)  echo -e "  ${CYAN}➜ Executing paymenter Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/paymenter/run.sh) 
                pause ;;
            ...
            9)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/mythical/run.sh) 
                pause ;;
