...
install_ptero() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/pterodactyl/install.sh)
...
while true; do
    ...
    case $choice in
        ...
        2) create_user ;;
        3) update_panel ;;
        4) bash <(curl -fsSL https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/pterodactyl/ssl.sh) ;;
        5) uninstall_ptero ;;
        6) bash <(curl -fsSL https://raw.githubusercontent.com/jayanthraju343-blip/JAYANTH-Cloud/refs/heads/main/panel/pterodactyl/phpMyAdmin.sh) ;;
        0) clear; exit ;;
